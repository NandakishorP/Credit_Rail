...
class Create3(Library):
    """
    [Source code](file:///opt/homebrew/lib/python3.13/site-packages/contracts/wake/Create3.sol#8)
    """
    ...
    class ErrorCreatingProxy(TransactionRevertedError):
        """
        [Source code](file:///opt/homebrew/lib/python3.13/site-packages/contracts/wake/Create3.sol#9)
        """
    ...
    class ErrorCreatingContract(TransactionRevertedError):
        """
        [Source code](file:///opt/homebrew/lib/python3.13/site-packages/contracts/wake/Create3.sol#10)
        """
    ...
    class TargetAlreadyExists(TransactionRevertedError):
        """
        [Source code](file:///opt/homebrew/lib/python3.13/site-packages/contracts/wake/Create3.sol#11)
        """
