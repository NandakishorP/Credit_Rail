...
class WakeHandler(Contract):
    """
    [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#9)
    """
    _abi = {'constructor': {'inputs': [{'internalType': 'contract LoanEngine', 'name': '_loanEngine', 'type': 'address'}, {'internalType': 'contract TranchePool', 'name': '_tranchePool', 'type': 'address'}, {'internalType': 'contract CreditPolicy', 'name': '_creditPolicy', 'type': 'address'}, {'internalType': 'contract ERC20Mock', 'name': '_usdt', 'type': 'address'}], 'stateMutability': 'nonpayable', 'type': 'constructor'}, b'\xfa\xad\xdb\x94': {'inputs': [], 'name': 'creditPolicy', 'outputs': [{'internalType': 'contract CreditPolicy', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'zI?/': {'inputs': [{'internalType': 'uint256', 'name': 'userIndex', 'type': 'uint256'}, {'internalType': 'uint256', 'name': 'amount', 'type': 'uint256'}], 'name': 'depositSeniorTranche', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function'}, b'\xa3\xb9?\xff': {'inputs': [], 'name': 'equityTrancheDeployedValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\xb7\xc9\xd5\xb6': {'inputs': [], 'name': 'equityTrancheIdleValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\x9e\x95O\xd0': {'inputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'name': 'equityUsers', 'outputs': [{'internalType': 'address', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'b\xb8\x14G': {'inputs': [], 'name': 'juniorTrancheDeployedValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\xcd\xf92\x9e': {'inputs': [], 'name': 'juniorTrancheIdleValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\xf5\xd6V\x96': {'inputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'name': 'juniorUsers', 'outputs': [{'internalType': 'address', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'Cdop': {'inputs': [], 'name': 'loanEngine', 'outputs': [{'internalType': 'contract LoanEngine', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'\xe6\x91\xbb\x9e': {'inputs': [], 'name': 'outStandingPrincipal', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'@k\xf6p': {'inputs': [], 'name': 'seniorTrancheDeployedValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\xe5\x1eC\xc2': {'inputs': [], 'name': 'seniorTrancheIdleValue', 'outputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'stateMutability': 'view', 'type': 'function'}, b'\x85&n\x18': {'inputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}], 'name': 'seniorUsers', 'outputs': [{'internalType': 'address', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'}\xf0\xa8\x06': {'inputs': [], 'name': 'tranchePool', 'outputs': [{'internalType': 'contract TranchePool', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}, b'/H\xab}': {'inputs': [], 'name': 'usdt', 'outputs': [{'internalType': 'contract ERC20Mock', 'name': '', 'type': 'address'}], 'stateMutability': 'view', 'type': 'function'}}
    _storage_layout = {"storage":[{"astId":7842,"contract":"tests/WakeHandler.sol:WakeHandler","label":"loanEngine","offset":0,"slot":0,"type":"t_contract(LoanEngine)4217"},{"astId":7845,"contract":"tests/WakeHandler.sol:WakeHandler","label":"tranchePool","offset":0,"slot":1,"type":"t_contract(TranchePool)7495"},{"astId":7848,"contract":"tests/WakeHandler.sol:WakeHandler","label":"usdt","offset":0,"slot":2,"type":"t_contract(ERC20Mock)415"},{"astId":7851,"contract":"tests/WakeHandler.sol:WakeHandler","label":"creditPolicy","offset":0,"slot":3,"type":"t_contract(CreditPolicy)2872"},{"astId":7853,"contract":"tests/WakeHandler.sol:WakeHandler","label":"seniorTrancheIdleValue","offset":0,"slot":4,"type":"t_uint256"},{"astId":7855,"contract":"tests/WakeHandler.sol:WakeHandler","label":"seniorTrancheDeployedValue","offset":0,"slot":5,"type":"t_uint256"},{"astId":7857,"contract":"tests/WakeHandler.sol:WakeHandler","label":"juniorTrancheIdleValue","offset":0,"slot":6,"type":"t_uint256"},{"astId":7859,"contract":"tests/WakeHandler.sol:WakeHandler","label":"juniorTrancheDeployedValue","offset":0,"slot":7,"type":"t_uint256"},{"astId":7861,"contract":"tests/WakeHandler.sol:WakeHandler","label":"equityTrancheIdleValue","offset":0,"slot":8,"type":"t_uint256"},{"astId":7863,"contract":"tests/WakeHandler.sol:WakeHandler","label":"equityTrancheDeployedValue","offset":0,"slot":9,"type":"t_uint256"},{"astId":7865,"contract":"tests/WakeHandler.sol:WakeHandler","label":"outStandingPrincipal","offset":0,"slot":10,"type":"t_uint256"},{"astId":7868,"contract":"tests/WakeHandler.sol:WakeHandler","label":"seniorUsers","offset":0,"slot":11,"type":"t_array(t_address)dyn_storage"},{"astId":7871,"contract":"tests/WakeHandler.sol:WakeHandler","label":"juniorUsers","offset":0,"slot":12,"type":"t_array(t_address)dyn_storage"},{"astId":7874,"contract":"tests/WakeHandler.sol:WakeHandler","label":"equityUsers","offset":0,"slot":13,"type":"t_array(t_address)dyn_storage"}],"types":{"t_address":{"encoding":"inplace","label":"address","numberOfBytes":20},"t_array(t_address)dyn_storage":{"encoding":"dynamic_array","label":"address[]","numberOfBytes":32,"base":"t_address"},"t_contract(CreditPolicy)2872":{"encoding":"inplace","label":"contract CreditPolicy","numberOfBytes":20},"t_contract(ERC20Mock)415":{"encoding":"inplace","label":"contract ERC20Mock","numberOfBytes":20},"t_contract(LoanEngine)4217":{"encoding":"inplace","label":"contract LoanEngine","numberOfBytes":20},"t_contract(TranchePool)7495":{"encoding":"inplace","label":"contract TranchePool","numberOfBytes":20},"t_uint256":{"encoding":"inplace","label":"uint256","numberOfBytes":32}}}
    _creation_code = ""
    ...
    def deploy(cls, _loanEngine: LoanEngine, _tranchePool: TranchePool, _creditPolicy: CreditPolicy, _usdt: ERC20Mock, *, from_: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, return_tx: Literal[False] = False, request_type: Literal["call"], chain: Optional[Chain] = None, gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> bytearray:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#30)
    ...
    @overload
    @classmethod
    def deploy(cls, _loanEngine: LoanEngine, _tranchePool: TranchePool, _creditPolicy: CreditPolicy, _usdt: ERC20Mock, *, from_: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, return_tx: Literal[False] = False, request_type: Literal["tx"] = "tx", chain: Optional[Chain] = None, gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> WakeHandler:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#30)
    ...
    def deploy(cls, _loanEngine: LoanEngine, _tranchePool: TranchePool, _creditPolicy: CreditPolicy, _usdt: ERC20Mock, *, from_: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, return_tx: bool = False, request_type: RequestType = "tx", chain: Optional[Chain] = None, gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Union[bytearray, WakeHandler, int, Tuple[Dict[Address, List[int]], int], TransactionAbc[WakeHandler]]:
        ...
        Args:
            ...
            _usdt: contract ERC20Mock
        """
        return cls._deploy(request_type, [_loanEngine, _tranchePool, _creditPolicy, _usdt], return_tx, WakeHandler, from_, value, gas_limit, {}, chain, gas_price, max_fee_per_gas, max_priority_fee_per_gas, access_list, type, block, confirmations)
    ...
    def loanEngine(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> LoanEngine:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#10)

        Returns:
            loanEngine: contract LoanEngine
        """
        ...
    ...
    def loanEngine(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: RequestType = 'call', gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Union[LoanEngine, TransactionAbc[LoanEngine], int, Tuple[Dict[Address, List[int]], int]]:
        ...
        Returns:
            loanEngine: contract LoanEngine
        """
        return self._execute(self.chain, request_type, "43646f70", [], True if request_type == "tx" else False, LoanEngine, from_, to if to is not None else str(self.address), value, gas_limit, gas_price, max_fee_per_gas, max_priority_fee_per_gas, access_list, type, block, confirmations)
    ...
    def tranchePool(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> TranchePool:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#11)

        Returns:
            tranchePool: contract TranchePool
        """
        ...
    ...
    def tranchePool(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: RequestType = 'call', gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Union[TranchePool, TransactionAbc[TranchePool], int, Tuple[Dict[Address, List[int]], int]]:
        ...
        Returns:
            tranchePool: contract TranchePool
        """
        return self._execute(self.chain, request_type, "7df0a806", [], True if request_type == "tx" else False, TranchePool, from_, to if to is not None else str(self.address), value, gas_limit, gas_price, max_fee_per_gas, max_priority_fee_per_gas, access_list, type, block, confirmations)
    ...
    def usdt(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> ERC20Mock:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#12)

        Returns:
            usdt: contract ERC20Mock
        """
        ...
    ...
    def usdt(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: RequestType = 'call', gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Union[ERC20Mock, TransactionAbc[ERC20Mock], int, Tuple[Dict[Address, List[int]], int]]:
        ...
        Returns:
            usdt: contract ERC20Mock
        """
        return self._execute(self.chain, request_type, "2f48ab7d", [], True if request_type == "tx" else False, ERC20Mock, from_, to if to is not None else str(self.address), value, gas_limit, gas_price, max_fee_per_gas, max_priority_fee_per_gas, access_list, type, block, confirmations)
    ...
    def creditPolicy(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> CreditPolicy:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#13)

        Returns:
            creditPolicy: contract CreditPolicy
        """
        ...
    ...
    def creditPolicy(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: RequestType = 'call', gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Union[CreditPolicy, TransactionAbc[CreditPolicy], int, Tuple[Dict[Address, List[int]], int]]:
        ...
        Returns:
            creditPolicy: contract CreditPolicy
        """
        return self._execute(self.chain, request_type, "faaddb94", [], True if request_type == "tx" else False, CreditPolicy, from_, to if to is not None else str(self.address), value, gas_limit, gas_price, max_fee_per_gas, max_priority_fee_per_gas, access_list, type, block, confirmations)
    ...
    def seniorTrancheIdleValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#16)
    ...
    def seniorTrancheDeployedValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#17)
    ...
    def juniorTrancheIdleValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#18)
    ...
    def juniorTrancheDeployedValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#19)
    ...
    def equityTrancheIdleValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#20)
    ...
    def equityTrancheDeployedValue(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#21)
    ...
    def outStandingPrincipal(self, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> uint256:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#23)
    ...
    def seniorUsers(self, index0: int, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Address:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#26)
    ...
    def juniorUsers(self, index0: int, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Address:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#27)
    ...
    def equityUsers(self, index0: int, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"] = "call", gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> Address:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#28)
    ...
    def depositSeniorTranche(self, userIndex: uint256, amount: uint256, *, from_: Optional[Union[Account, Address, str]] = None, to: Optional[Union[Account, Address, str]] = None, value: Union[int, str] = 0, gas_limit: Optional[Union[int, Literal["max"], Literal["auto"]]] = None, request_type: Literal["call"], gas_price: Optional[Union[int, str]] = None, max_fee_per_gas: Optional[Union[int, str]] = None, max_priority_fee_per_gas: Optional[Union[int, str]] = None, access_list: Optional[Union[Dict[Union[Account, Address, str], List[int]], Literal["auto"]]] = None, type: Optional[int] = None, block: Optional[Union[int, Literal["latest"], Literal["pending"], Literal["earliest"], Literal["safe"], Literal["finalized"]]] = None, confirmations: Optional[int] = None) -> None:
        """
        [Source code](file:///Users/admin/Desktop/credit_rail/contracts/tests/WakeHandler.sol#43)
...
WakeHandler.loanEngine.selector = bytes4(b'Cdop')
WakeHandler.tranchePool.selector = bytes4(b'}\xf0\xa8\x06')
WakeHandler.usdt.selector = bytes4(b'/H\xab}')
WakeHandler.creditPolicy.selector = bytes4(b'\xfa\xad\xdb\x94')
WakeHandler.seniorTrancheIdleValue.selector = bytes4(b'\xe5\x1eC\xc2')
WakeHandler.seniorTrancheDeployedValue.selector = bytes4(b'@k\xf6p')
WakeHandler.juniorTrancheIdleValue.selector = bytes4(b'\xcd\xf92\x9e')
WakeHandler.juniorTrancheDeployedValue.selector = bytes4(b'b\xb8\x14G')
WakeHandler.equityTrancheIdleValue.selector = bytes4(b'\xb7\xc9\xd5\xb6')
WakeHandler.equityTrancheDeployedValue.selector = bytes4(b'\xa3\xb9?\xff')
WakeHandler.outStandingPrincipal.selector = bytes4(b'\xe6\x91\xbb\x9e')
WakeHandler.seniorUsers.selector = bytes4(b'\x85&n\x18')
WakeHandler.juniorUsers.selector = bytes4(b'\xf5\xd6V\x96')
WakeHandler.equityUsers.selector = bytes4(b'\x9e\x95O\xd0')
WakeHandler.depositSeniorTranche.selector = bytes4(b'zI?/')
