...
contract MedusaTest {
    ...
    function depositSenior(uint256 userSeed, uint256 amount) external {
        ...
        uint256 remaining = tranchePool.getSeniorTrancheMaxDepositCap() -
            currentValue;
    ...
    function depositJunior(uint256 userSeed, uint256 amount) external {
        ...
        uint256 remaining = tranchePool.getJuniorTrancheMaxDepositCap() -
            currentValue;
        amount = _min(amount, remaining);
    ...
    function depositEquity(uint256 userSeed, uint256 amount) external {
        ...
        uint256 remaining = tranchePool.getEquityTrancheMaxDepositCap() -
            currentValue;
        amount = _min(amount, remaining);
    ...
    function invariant_deployedMatchesOutstanding()
        external
        view
        returns (bool)
    {
    ...
    function invariant_interestMonotonicity() external view returns (bool) {
        return
            tranchePool.getSeniorInterestIndex() >= 1e18 &&
