...
contract MockPoseidon2 is IPoseidon2 {
    ...
    function hash(Field.Type[] memory input, uint256 std_input_length, bool is_variable_length)
        ...
        returns (Field.Type)
    {
        return Field.toField(uint256(keccak256(abi.encode(input, std_input_length, is_variable_length))));
    }
}
